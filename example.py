""" An example experiment, see exp() for details:

Usage
-----
* Command line:
    python ./example_fh.py   ## Runs many ROIs (runtime is ~10 hours)
...
def exp(roi, table, verbose=True):
    """
    An (example) experimental function to classify a ROI from the 
...
if __name__ == "__main__":
    ...
    # --
    # Exp globals
    ACCURACY_TABLE_NAME = "fh_example_accuracy.txt"
