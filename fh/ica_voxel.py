"""ICA deomposition for all voxels and trials.  Results saved to a series
of tables named like <name>_<roi>_<cond>.csv.

usage: python ./ica_space.py name roifile cond [, filtfile]
"""
import sys, os
import numpy as np
...
from fmrilearnexp.base import Voxel
...
# ---------------------------------------------------------------------------
data = FH()
spacetime = Voxel(FastICA(6, whiten=True), mode="decompose")
