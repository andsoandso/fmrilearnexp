"""FactorAnalysis reduction for all voxels and trials.  Results saved to a series
of tables named like <name>_<roi>_<cond>.csv.

usage: python ./fa_time.py name roifile cond [, filtfile]
"""
import sys, os
import numpy as np
...
# Setup exp
# ---------------------------------------------------------------------------
spacetime = Time(FactorAnalysis(6))
